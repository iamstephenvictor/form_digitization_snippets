Qualtrics.SurveyEngine.addOnload(function() {
            ...
            try {
                var fp = flatpickr(inputElement, {
                    ...
                    onChange: function(selectedDates, dateStr, instance) {
                        ...
                        Qualtrics.SurveyEngine.setJSEmbeddedData('DatesOfAccreditationRange', dateStr);
                        ...
                        if (selectedDates.length === 2) {
                            ...
                            Qualtrics.SurveyEngine.setJSEmbeddedData('DatesOfAccreditationStart', startDate);
                            Qualtrics.SurveyEngine.setJSEmbeddedData('DatesOfAccreditationEnd', endDate);
                            
                            // Optional: Calculate days in range
                            var daysDiff = Math.floor((selectedDates[1] - selectedDates[0]) / (1000 * 60 * 60 * 24)) + 1;
                            Qualtrics.SurveyEngine.setJSEmbeddedData('DatesOfAccreditationDays', daysDiff);
                        }
                    }
                });
                ...
                inputElement.addEventListener('change', function(e) {
                    Qualtrics.SurveyEngine.setJSEmbeddedData('DatesOfAccreditationRange', e.target.value);
                });
            }
        }, 500);
    }
    ...
    if (typeof flatpickr !== 'undefined') {
        ...
        script.onerror = function() {
            ...
            setTimeout(function() {
                var input = document.querySelector("[id*='" + questionId + "'] input[type=text]");
                if (input) {
                    ...
                    input.addEventListener('change', function(e) {
                        ...
                        if (value.includes(' - ') || value.includes(' to ')) {
                            ...
                            if (parts.length >= 3) {
                                Qualtrics.SurveyEngine.setJSEmbeddedData('DatesOfAccreditationStart', parts[0]);
                                Qualtrics.SurveyEngine.setJSEmbeddedData('DatesOfAccreditationEnd', parts[2]);
                            }
                        }
                    });
                }
