        ...
        setTimeout(function() {
            ...
            try {
                var fp = flatpickr(inputElement, {
                    ...
                    onChange: function(selectedDates, dateStr, instance) {
                        if (selectedDates.length === 1) {
                            ...
                            Qualtrics.SurveyEngine.setJSEmbeddedData('DateDeterminationIsMade', dateStr);
                        }
                    }
                });
                ...
                inputElement.addEventListener('change', function(e) {
                    Qualtrics.SurveyEngine.setJSEmbeddedData('DateDeterminationIsMade', e.target.value);
                });
            }
        }, 500);
    }
